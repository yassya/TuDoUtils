...
'''
from TuDoUtils.plotClass import *
...
myFirstPlot.FillRandom("gaus",1000);
...
mySecondPlot.FillRandom("gaus",10000) # to have something to see in the ratio 
mySecondPlot.Scale(0.1) # and get them to the same area
